...
const TasksPage = () => {
  ...
  { id: 7, title: "Mathematics Olympiad Problem Set Design", subject: "Math", description: "Create challenging and original problem sets for high school math competitions. Include solutions and difficulty ratings.", budget: "80-150", deadline: "5 days", postedBy: "MathNerd", postedDate: "4 hours ago", status: "Open" },
  ...
  { id: 12, title: "Design a Philosophy Logic Puzzle Set", subject: "Philosophy", description: "Create logic puzzles inspired by classic philosophical paradoxes and dilemmas. Suitable for classroom use.", budget: "70-120", deadline: "5 days", postedBy: "EthicsThinker", postedDate: "2 hours ago", status: "Open" },
  { id: 13, title: "Experimental Design: Learning Styles in Children", subject: "Education", description: "Assist in designing a small-scale experiment evaluating the effectiveness of different teaching methods.", budget: "130-220", deadline: "7 days", postedBy: "EduLab", postedDate: "5 hours ago", status: "Open" },
